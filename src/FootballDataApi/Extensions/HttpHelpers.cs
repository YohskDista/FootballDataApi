...
internal static class HttpHelpers
{
    ...
    public static IReadOnlyCollection<string> FilterNotPresentInList(string[] authorizedFilters, string[] filters)
    {
        return filters
    ...
    public static void VerifyMatchDayFilterValid(string matchDay)
    {
    ...
    public static void VerifyStatusFilterValid(string status)
    {
    ...
    public static void VerifyVenueFilterValid(string venue)
    {
    ...
    public static void VerifyDateFilterValid(string date)
    {
    ...
    public static void VerifyStageFilterValid(string stage)
    {
